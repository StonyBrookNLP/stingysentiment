...
parser_file.add_argument('I', metavar='input_path', type=str, help="Path of input file")
parser_file.add_argument('O', metavar='output_path', type=str, help="Path of output file")
