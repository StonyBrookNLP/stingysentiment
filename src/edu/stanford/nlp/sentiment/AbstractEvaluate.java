...
public abstract class AbstractEvaluate {
    ...
    /*Code added by Ankit Gupta */
    protected static int[][] shrinkConfusionMatrix(int[][] confusion) {
        int[][] result = new int[3][3];
        result[0][0] = confusion[0][0] + confusion[0][1] + confusion[1][0] + confusion[1][1];
        result[0][1] = confusion[0][2] + confusion[1][2];
        result[0][2] = confusion[0][3] + confusion[0][4] + confusion[1][3] + confusion[1][4];
        result[1][0] = confusion[2][0] + confusion[2][1];
        result[1][1] = confusion[2][2];
        result[1][2] = confusion[2][3] + confusion[2][4];
        result[2][0] = confusion[3][0] + confusion[3][1] + confusion[4][0] + confusion[4][1];
        result[2][1] = confusion[3][2] + confusion[4][2];
        result[2][2] = confusion[3][3] + confusion[3][4] + confusion[4][3] + confusion[4][4];
        return result;
    }
    /*Code added by Ankit Gupta */
    ...
    public void printSummary() {
        ...
        /*Code added by Ankit Gupta */
        int[][] labelShrank = shrinkConfusionMatrix(labelConfusion);
        int[][] rootLabelShrank = shrinkConfusionMatrix(rootLabelConfusion);
        printConfusionMatrix("Label", labelShrank);
        printConfusionMatrix("Root label", rootLabelShrank);
        /*Code added by Ankit Gupta */
