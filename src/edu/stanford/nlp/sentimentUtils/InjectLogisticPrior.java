 ...
 */
public class InjectLogisticPrior {

    public InjectLogisticPrior() {
    }
    ...
    protected static double[] phraseVector(int phraseLength) {
    ...
    protected static void changeLabel(Tree tree, double[] phraseVector) {
        ...
        if (Integer.parseInt(label.value()) != value) {
            labelChanged++;
        }
    ...
    protected static void changePhraseLabel(Tree tree, Tree root, int phraseLength) {
        ...
        if (tree.isPhrasal()) {
            ...
            if (tree.getLeaves().size() == phraseLength) {
                ...
                changeLabel(tree, phraseVector(phraseLength));
            }
        }
    }
